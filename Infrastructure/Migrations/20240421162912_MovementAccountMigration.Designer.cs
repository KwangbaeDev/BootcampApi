...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240421162912_MovementAccountMigration")]
    partial class MovementAccountMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.MovementAccount", b =>
                {
                    ...
                    b.HasKey("MovementId", "AccountId", "TransferId");

                    b.HasIndex("AccountId");

                    b.HasIndex("TransferId");

                    b.ToTable("MovementAccounts");
                });
            ...
            modelBuilder.Entity("Core.Entities.Transfer", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Account", "SourceAccount")
                        .WithMany()
