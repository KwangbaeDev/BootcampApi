...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240418145625_ApplicationFormAndProductMigration")]
    partial class ApplicationFormAndProductMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.Credit", b =>
                {
                    b.HasOne("Core.Entities.ApplicationForm", "ApplicationForm")
                        .WithOne("Credit")
                        .HasForeignKey("Core.Entities.Credit", "ApplicationFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.CreditCard", b =>
                {
                    b.HasOne("Core.Entities.ApplicationForm", "ApplicationForm")
                        .WithOne("CreditCard")
                        .HasForeignKey("Core.Entities.CreditCard", "ApplicationFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.CurrentAccount", b =>
                {
                    ...
                    b.HasOne("Core.Entities.ApplicationForm", "ApplicationForm")
                        .WithOne("CurrentAccount")
                        .HasForeignKey("Core.Entities.CurrentAccount", "ApplicationFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
